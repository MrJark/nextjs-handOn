...
export default function DashboardLayout({
 ...
 children: React.ReactNode;
  ...
  return (
    <div className=" bg-slate-800 overflow-y-scroll w-screen h-screen antialiased text-slate-300 selection:bg-blue-600 selection:text-white">
        <div className="flex flex-col relative w-screen">
            <div id="menu" className="bg-gray-950 min-h-screen z-10 text-slate-300 w-64 fixed left-0 h-screen overflow-y-scroll">
              ...
              <div id="profile" className="px-6 py-10">
                ...
                <a href="#" className="inline-flex space-x-2 items-center">
                    <span>
                        <img className="rounded-full w-8 h-8" src="https://unavatar.io/github/mrjark" alt="mrjark foto"/>
                    </span>
