...
export const SidebarMenuItem = ({ path, icon, subtitle, title}: Props) => {
    return (
        <a href="#" className="w-full px-2 mt-3 inline-flex space-x-2 items-center border-b border-slate-700 py-3 bg-gray-900 hover:bg-white/5 transition ease-linear duration-150">
            <div>
