      ...
      <aside className="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
        <div>
          <div className="-mx-6 px-6 py-4">
            ...
            <a href="#" title="home">
              {/* Next/Image */}
              <Image src="https://tailus.io/sources/blocks/stats-cards/preview/images/logo.svg" className="w-24" alt="tailus logo" width={32} height={32}/>
            </a>
          </div>

          <div className="mt-8 text-center">
            {/* Next/Image */}
            <Image src="https://unavatar.io/github/mrjark" alt="" className="w-10 h-10 m-auto rounded-full object-cover lg:w-16 lg:h-16"  width={24} height={24}/>
